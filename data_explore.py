# Data collection scripts for Google ClusterData2011_2
# Includes EDA, aggregation, and window creation

# Move this file to data_collection/
# Usage: python data_explore.py
...
if 'start_time' in df.columns:
    ...
    output_path = os.path.join(os.path.dirname(__file__), '../data_collection/per_minute_agg.csv')
